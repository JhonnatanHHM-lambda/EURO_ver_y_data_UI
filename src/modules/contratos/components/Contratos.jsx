    ...
    return (
        <div className="vyd-main fade-in">
            ...
            <div className="vyd-page-header">
                <div>
                    <h1 className="vyd-page-title"><FiFileText size={20} /> Contratos</h1>
                    <p className="vyd-page-sub">Gestión de vencimientos, firma digital y decisiones de director</p>
                </div>
